              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-primary-white font-serif">
                        Watchtower
                      </h2>
                  ...
                  <p className="text-xl text-secondary-muted mb-6 leading-relaxed">
                    Community safety reporting and triage dashboard with
                    real-time incident tracking, neighborhood alerts, and
                    analytics.
                  </p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <a
                      href="/blog/2025-06-01-how-tech-can-boost-community-safety"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="card text-center">
                ...
                <p className="text-secondary-muted text-sm">
                  Interactive maps showing safety resources, incident reports,
                  and community assets with privacy controls.
                </p>
              </div>
              <div className="card text-center">
                ...
                <p className="text-secondary-muted text-sm">
                  Responsive design optimized for mobile devices with offline
              ...
              <div className="card text-center">
                ...
                <p className="text-secondary-muted text-sm">
                  Community leaders can view safety trends, response times, and
                  impact metrics with customizable reports.
                </p>
              </div>
              <div className="card text-center">
                ...
                <p className="text-secondary-muted text-sm">
                  End-to-end encryption, community data ownership, and
                  transparent algorithms that communities can audit.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="card">
                ...
                <p className="text-secondary-muted mb-4">
                  Interactive mapping platform for community safety resources
              ...
              <div className="card">
                ...
                <p className="text-secondary-muted mb-4">
                  Emergency notification system for community-wide alerts and
          ...
          <div className="card">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-secondary-muted max-w-3xl mx-auto">
                We work with cities, nonprofits, and community groups to deploy
                our safety technology. Contact us to discuss pilot programs and
                partnerships.
              </p>
            </div>
            <ContactForm />
...
export const getStaticProps: GetStaticProps = async () => {
  const software = [
    ...
    },
    {
      ...
      name: 'Safety Map',
      description:
        'Interactive mapping platform for community safety resources, incident reports, and neighborhood assets.',
      features: [
    ...
    },
    {
      ...
      description:
        'Emergency notification system for community-wide alerts, safety updates, and resource mobilization.',
      features: [
